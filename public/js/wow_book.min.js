...
! function(d, n) {
	...
	var l = g.utils = {
		...
		each: function(a, b, c) {
			...
			if ("forEach" in a) a.forEach(b, c);
				...
				for (e in a)
					if (a.hasOwnProperty(e) && !1 === b.call(c, a[e], e, a)) break
		},
		inStr: function(a, b) {
	...
	var q = g.event = {
		...
		determineEventTypes: function() {
			var a;
			return a = g.HAS_POINTEREVENTS ? d.PointerEvent ? ["pointerdown", "pointermove", "pointerup pointercancel lostpointercapture"] : ["MSPointerDown", "MSPointerMove", "MSPointerUp MSPointerCancel MSLostPointerCapture"] : g.NO_MOUSEEVENTS ? ["touchstart", "touchmove", "touchend touchcancel"] :
				["touchstart mousedown", "touchmove mousemove", "touchend touchcancel mouseup"], m[b] = a[0], m[e] = a[1], m[f] = a[2], m
		},
...
(function(d) {
	...
	n.prototype = {
		...
		back: function(e) {
			if (typeof(drawed) == 'undefined' || drawed == false) {
				turnPage = false;
				drawed = false;
		...
		controllify: function(a) {
			...
			d(a.next).on("click.wowbook", function(e) {

				c.advance(e);
				return !1
			});
			d(a.back).on("click.wowbook", function(e) {
